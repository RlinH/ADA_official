...
if __name__ == '__main__':
    ...
    for x in ['Domain4']:
        args.dataset = x
        args.out = osp.join('logs_train','Visualization', 'Prostate', args.dataset, "mobilenet", current_time)
        ...
        # 2. modelFFNET
        if method == 'CCSDG':
            model = DeepLab(num_classes=1, backbone="ADA", output_stride=args.out_stride,
